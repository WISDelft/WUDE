...
public class FollowersToFile {
	...
	public void setup() {
		...
		path = TestConstants.outputDir + FollowerGathererThread.getOutputDirSuffix() + "/" + datePath + "/";
	}
	...
	@Test
	public void testOverwrite() throws IOException, TwitterException{
		appConfig.ids = new long[] { TestConstants.publicAccount };
		appConfig.fileOverwrite = false;
